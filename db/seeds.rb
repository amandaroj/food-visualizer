...
jarritos = Dish.new(dish_type: :main, average_rating: 5, name: "Jarritos", menu_id: m.id, description: "Mexican Soda", price: 11)
...
fries = Dish.new(dish_type: :side, average_rating: 3, name: "Fries", menu_id: lkm.id, description: "Homemade french fries", price: 7)
