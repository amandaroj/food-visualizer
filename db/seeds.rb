...
tacos = Dish.new(average_rating: 4, name: "Tacos", menu_id: m.id, description: "Corn-based tortilla", price: 11)
...
jarritos = Dish.new(average_rating: 5, name: "Jarritos", menu_id: m.id, description: "Mexican Soda", price: 11)
...
churros = Dish.new(average_rating: 5, name: "Churros", menu_id: m.id, description: "Delicious vegan homemade churros", price: 11)
...
pizza = Dish.new(average_rating: 3, name: "Pizza", menu_id: m.id, description: "Pizza with tomato sauce and other stuff", price: 9)
...
brownie = Dish.new(average_rating: 3, name: "Brownie", menu_id: m.id, description: "Chocolate brownie, very nice", price: 4)
...
onionsoup = Dish.new(average_rating: 3, name: "Onion Soup", menu_id: dm.id, description: "Soup with onions and butter", price: 13)
...
pizza = Dish.new(average_rating: 3, name: "Pizza", menu_id: dm.id, description: "Pizza with tomato sauce and other stuff", price: 9)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662462452/FoodVisualizer/mozzarella-pizza_xspplw.jpg")
pizza.photos.attach(io: file, filename: "mozzarellapizza.jpg", content_type: "image/jpg")
pizza.save
puts "Created #{pizza.name}!"

cheesecake = Dish.new(average_rating: 3, name: "Cheesecake", menu_id: dm.id, description: "Unique type of cake", price: 5)
...
churros = Dish.new(average_rating: 3, name: "Churros", menu_id: dm.id, description: "Delicious vegan homemade churros", price: 11)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662475217/FoodVisualizer/churros_lkpkor.jpg")
churros.photos.attach(io: file, filename: "churros.jpg", content_type: "image/jpg")
churros.save
puts "Created #{churros.name}!"
...
cesarsalad = Dish.new(average_rating: 3, name: "Cesar Salad", menu_id: sm.id, description: "Chopped romaine lettuce with garlicky croutons and a creamy sauce", price: 9)
...
guacamole = Dish.new(average_rating: 3, name: "Guacamole", menu_id: sm.id, description: "Creamy, avocado-based dip", price: 7)
...
sangria = Dish.new(average_rating: 3, name: "Sangria", menu_id: sm.id, description: "White rum cocktail", price: 8)
...
icecream = Dish.new(average_rating: 3, name: "Pssion Fruit Ice Cream", menu_id: sm.id, description: "Homemade passion fruit ice cream", price: 4)
...
quesadilla = Dish.new(average_rating: 3, name: "Quesadilla", menu_id: sm.id, description: "Tortilla filled with cheese", price: 11)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662474975/FoodVisualizer/quesadilla_zvq6hw.jpg")
quesadilla.photos.attach(io: file, filename: "quesadilla.jpg", content_type: "image/jpg")
quesadilla.save
puts "Created #{quesadilla.name}!"

tacos = Dish.new(average_rating: 3, name: "Tacos", menu_id: sm.id, description: "Corn-based tortilla", price: 11)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662475138/FoodVisualizer/tacos_m7dzgc.jpg")
tacos.photos.attach(io: file, filename: "tacos.jpg", content_type: "image/jpg")
tacos.save
puts "Created #{tacos.name}!"

jarritos = Dish.new(average_rating: 3, name: "Jarritos", menu_id: sm.id, description: "Mexican Soda", price: 3)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662475340/FoodVisualizer/jarritos_mqbpqs.jpg")
jarritos.photos.attach(io: file, filename: "jarritos.jpg", content_type: "image/jpg")
jarritos.save
puts "Created #{jarritos.name}!"

churros = Dish.new(average_rating: 3, name: "Churros", menu_id: sm.id, description: "Delicious vegan homemade churros", price: 11)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662475217/FoodVisualizer/churros_lkpkor.jpg")
churros.photos.attach(io: file, filename: "churros.jpg", content_type: "image/jpg")
churros.save
puts "Created #{churros.name}!"
...
poke = Dish.new(average_rating: 3, name: "Poke", menu_id: lkm.id, description: "Diced raw fish", price: 9)
...
fries = Dish.new(average_rating: 3, name: "Fries", menu_id: lkm.id, description: "Homemade french fries", price: 7)
...
hazelnutbrownie = Dish.new(average_rating: 3, name: "Homemade Brownie", menu_id: lkm.id, description: "Chocolat brownie with hazelnut", price: 4)
...
cesarsalad = Dish.new(average_rating: 3, name: "Cesar Salad", menu_id: lfm.id, description: "Chopped romaine lettuce with garlicky croutons and a creamy sauce", price: 9)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662462449/FoodVisualizer/ceasar-salad_ozank0.jpg")
cesarsalad.photos.attach(io: file, filename: "cesarsalad.jpg", content_type: "image/jpg")
cesarsalad.save
puts "Created #{cesarsalad.name}!"
...
pepperonipizza = Dish.new(average_rating: 3, name: "Pepperoni Pizza", menu_id: lfm.id, description: "Mozzarela, tomato sauce and pepperoni", price: 12)
...
mozzarellapizza = Dish.new(average_rating: 3, name: "Mozzarella Pizza", menu_id: lfm.id, description: "Mozzarela, basil and tomato sauce", price: 10)
file = URI.open("https://res.cloudinary.com/dmxsjswbi/image/upload/v1662462452/FoodVisualizer/mozzarella-pizza_xspplw.jpg")
...
aperol = Dish.new(average_rating: 3, name: "Aperol Spritz", menu_id: lfm.id, description: "Prosecco Cocktail with orange slice", price: 23)
...
bobun = Dish.new(average_rating: 3, name: "Bò Bún", menu_id: vlm.id, description: "Rice vermicelli with stir-fried beef and spring rolls", price: 11)
...
bahnmi = Dish.new(average_rating: 3, name: "Bahn Mi ", menu_id: vlm.id, description: "Baguette with grilled pork", price: 6)
...
pho = Dish.new(average_rating: 3, name: "Pho", menu_id: vlm.id, description: "Chicken rice noodle special soup", price: 8)
...
buncha = Dish.new(average_rating: 3, name: "Bún Chà", menu_id: vlm.id, description: "Rice vermicelli with grilled pork and meatball", price: 10)
